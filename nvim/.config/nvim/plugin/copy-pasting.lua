...
wk.add({
    -- { "y.", ":let @+=@%<CR>", desc = "Yank current filepath" },
    {
        "y.",
        yank_file_path,
    ...
    {
        "y,",
        yank_absolute_file_path,
        desc = "Yank current absolute filepath",
    },
    {
        "<leader>y.",
        function()
        ...
        desc = "Yank whole file for sharing",
    },
    {
        "<leader>y,",
        function()
    ...
    { "<leader>p", '"_dP', desc = "Paste without overwriting clipboard", mode = "v" },
